class UsersController < ApplicationController
    ...
    def create
        ...
        if params[:ref].present?
            ref_user = User.find(referral_code: params[:ref])
            if ref_user.referral_registered_number.present?
                ref_user.referral_registered_number = ref_user.referral_registered_number + 1
            else
                ref_user.referral_registered_number = 1
            end
        end
